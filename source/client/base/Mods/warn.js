...
<<<<<<< HEAD
    ...
    run: async (message, args, client) => {
        ...
        let no_reason = new client.Infinity_Gateway.MessageEmbed()
         ...
         let cases = await CASES.find({ user: member.user.id, guild: message.guild.id });
         ...
         let bot_warn = new client.Infinity_Gateway.MessageEmbed()
          ...
          .setColor("RED")
          .setThumbnail(client.logo)
          .setDescription("Warnings do not count towards bots. You are better off to just ban or kick them!")
          .setTimestamp()
          .setFooter({ text: client.footer, iconURL: client.logo })
          ...
          if (cases && cases.length == 3) {
            ...
            let embed = new client.Infinity_Gateway.MessageEmbed()
             ...
             await message.guild.members.ban(member, { reason: "Received 3 warnings or more!" });
      ...
      let embed = new client.Infinity_Gateway.MessageEmbed()
        ...
        .addFields(
          ...
          },
          {
            ...
            value: "``3``",
            inline: true,
>>>>>>> 1b34b694539e96baaab70f8cf41167ae9aaf9c19
          }
        )
        .setTimestamp()
        .setFooter({ text: client.footer, iconURL: client.logo });
