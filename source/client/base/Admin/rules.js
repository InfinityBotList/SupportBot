        ...
        const embed2 = new client.Infinity_Gateway.MessageEmbed()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: "Bots who provide music through YouTube will no longer be accepted in our list as it violates both the YouTube Terms of Service and Discord Terms of Service.",
                }
            )
            .setTimestamp()
            .setFooter({ text: client.footer, iconURL: client.glogo2 });
