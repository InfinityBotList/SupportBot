...
module.exports = {
    ...
    run: async(client, interaction) => {
        ...
        if (voteStatus.has_voted) has = `${member.user.username} has voted for our main bot recently!`
        else has = `${member.user.username} has not voted for our main bot recently, they must be pretty lame!`
