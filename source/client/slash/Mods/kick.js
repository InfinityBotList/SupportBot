module.exports = {
    ...
    run: async(client, interaction) => {
        ...
        if (member == interaction.member) return interaction.reply({ embeds: [embed2], ephemeral: true });
        if (!member.kickable) return interaction.reply({ embeds: [embed], ephemeral: true });
