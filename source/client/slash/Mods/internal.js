    ...
    run: async (client, interaction) => {
        switch (interaction.options.getSubcommand()) {
            ...
            case "view":
                ...
                let case_num1 = await interaction.options.getNumber(
                    "case_number"
                );

                if (!interaction.guild.id === "870950609291972618")
                    return interaction.reply({
                        embeds: [
                            new client.Infinity_Gateway.MessageEmbed()
                                ...
                                .setDescription(
                                    "Hold up chief, this command should be executed in the Infinity Bot List Staff Server!"
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                    ...
                    return interaction.reply({
                        embeds: [
                            new client.Infinity_Gateway.MessageEmbed()
                                ...
                                .setThumbnail(client.logo)
                                .setDescription(
                                    "It looks like this staff member has no active cases or that case does not exist"
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                ...
                return interaction.reply({
                    embeds: [
                        new client.Infinity_Gateway.MessageEmbed()
                            ...
                            .setThumbnail(client.logo)
                            .setDescription(
                                `Case information for ${u.user.username}`
                            )
                            .addFields(
                                {
                                    name: "Case Number",
                                ...
                                },
                                {
                                    name: "Moderator",
                                    value: `${
                                        client.users.cache.get(c.moderator)
                                            .username
                                    }`,
                                },
                                {
                    ...
                    return interaction.reply({
                        embeds: [
                            new client.Infinity_Gateway.MessageEmbed()
                                ...
                                .setThumbnail(client.logo)
                                .setDescription(
                                    "It looks like this staff member has no available cases"
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
            ...
            case "create":
                ...
                let audit_logs = await interaction.guild.channels.cache.find(
                    (c) => c.id === "1123655378702438400"
                );
                    ...
                    return interaction.reply({
                        embeds: [
                            new client.Infinity_Gateway.MessageEmbed()
                                ...
                                .setThumbnail(client.logo)
                                .setDescription(
                                    "You can not warn yourself noob, please mention someone else"
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                ...
                if (action_d.value === "3 Months") {
                    end = moment(interaction.createdAt)
                        .add(3, "months")
                        .format("MM-DD-YYYY");
                        ...
                        await audit_logs.send({
                            ...
                            embeds: [
                                new client.Infinity_Gateway.MessageEmbed()
                                    ...
                                    .setThumbnail(client.logo)
                                    .setDescription(
                                        `${staff_u.user.username} has received a new infraction`
                                    )
                                    .addFields(
                                        {
                                            name: "Case Number",
                        ...
                        return interaction.reply({
                            embeds: [
                                new client.Infinity_Gateway.MessageEmbed()
                                    ...
                                    .setThumbnail(client.logo)
                                    .setDescription(
                                        "Staff member has been warned successfully!"
                                    )
                                    .setTimestamp()
                                    .setFooter({
                                        text: client.footer,
            ...
            case "delete":
                ...
                let action_reason = await interaction.options.getString(
                    "reason"
                );
                let action_case = await interaction.options.getNumber(
                    "case_number"
                );
                let staff_logs = await interaction.guild.channels.cache.find(
                    (c) => c.id === "1128467438716067850"
                );
                ...
                if (staff_u2 == interaction.member)
                    return interaction.reply({
                        embeds: [
                            new client.Infinity_Gateway.MessageEmbed()
                                .setTitle("ERROR: Invalid User")
                                ...
                                .setThumbnail(client.logo)
                                .setDescription(
                                    "You can not delete your own infraction"
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                ...
                if (!client.perms.Admins.includes(interaction.member.user.id))
                    return interaction.reply({
                        embeds: [
                            new client.Infinity_Gateway.MessageEmbed()
                                ...
                                .setThumbnail(client.logo)
                                .setDescription(
                                    "Sorry, only the Infinity Owners can delete a infraction to prevent abuse"
                                )
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                            ...
                            return interaction.reply({
                                embeds: [
                                    new client.Infinity_Gateway.MessageEmbed()
                                        ...
                                        .setThumbnail(client.logo)
                                        .setDescription(
                                            "This user has no infractions or the case number does not exist"
                                        )
                                        .setTimestamp()
                                        .setFooter({
                                            text: client.footer,
                            ...
                            await staff_logs.send({
                                embeds: [
                                    new client.Infinity_Gateway.MessageEmbed()
                                        ...
                                        .setThumbnail(client.logo)
                                        .setDescription(
                                            `${interaction.member.user.username} has deleted a case`
                                        )
                                        .addFields(
                                            {
                                                name: "Case User",
                ...
                return interaction.reply({
                    embeds: [
                        new client.Infinity_Gateway.MessageEmbed()
                            ...
                            .setThumbnail(client.logo)
                            .setDescription(
                                "Hold up chief, you failed to provide any interaction arguments"
                            )
                            .setTimestamp()
                            .setFooter({
                                text: client.footer,
